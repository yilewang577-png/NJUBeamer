...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.5\linewidth]{pic/nju_logo.jpg}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{pic/nju_logo.jpg}
        \caption{这个校徽就是矢量图}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{pic/校训.jpg}
        %\caption{Caption}
        %\label{}
    \end{figure}
\end{frame}
